...
export default function About() {
  ...
  return (
    <section 
      id="about" 
      ref={sectionRef}
      className="relative w-full py-32 px-6 sm:px-12 lg:px-24 bg-transparent font-sans overflow-hidden"
    >
      {/* Atmosphere elements managed by Controller now */}
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-stretch">
        ...
        <div className="hidden lg:flex lg:col-span-6 justify-center lg:justify-start">
          <div 
            ref={portraitRef}
            className="relative w-full min-h-[500px] lg:h-full rounded-3xl overflow-hidden border transition-colors group"
        ...
        <div className="col-span-1 lg:col-span-6 flex flex-col justify-center space-y-8 text-left">
          <div className="space-y-2">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold tracking-tight transition-colors text-primary">
              About Me
            </h2>
          </div>
          ...
          <div 
            ref={contentRef}
            className="card p-8 sm:p-10 rounded-3xl shadow-2xl lg:max-w-[600px] h-full flex flex-col justify-center transition-all"
          >
            <div className="space-y-6 leading-relaxed text-base sm:text-lg font-light transition-colors text-muted">
              <p>
                I’m currently studying <span className="font-medium italic transition-colors text-primary">Computing with Artificial Intelligence</span> at Islington College, where I’m building a strong foundation in both software development and emerging technologies such as robotics, IoT, and artificial intelligence.
              </p>
              ...
              <p className="transition-colors text-primary opacity-80">
